 ...
 * <pre>
 * &lt;xs:complexType xmlns:xs="http://www.w3.org/2001/XMLSchema" name="ConsumerReferenceIdentification_62837_C_CUS_PNRDataFeed_132">
 *   &lt;xs:sequence>
 ...
 * </pre>
 */
public class ConsumerReferenceIdentification62837CCUSPNRDataFeed132
{
    private String referenceQualifier;
    private String referenceNumber;

    /** 
     * Get the 'referenceQualifier' element value. Indicator - 1  for ID (customer number) - CD for CD (customer discount number)
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'referenceQualifier' element value. Indicator - 1  for ID (customer number) - CD for CD (customer discount number)
     * 
