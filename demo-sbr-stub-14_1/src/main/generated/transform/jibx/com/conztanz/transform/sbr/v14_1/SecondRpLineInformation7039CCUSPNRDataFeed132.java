 ...
 * <pre>
 * &lt;xs:complexType xmlns:xs="http://www.w3.org/2001/XMLSchema" name="SecondRpLineInformation_7039_C_CUS_PNRDataFeed_132">
 *   &lt;xs:sequence>
 ...
 * </pre>
 */
public class SecondRpLineInformation7039CCUSPNRDataFeed132
{
    ...
    /** 
     * Get the 'agentSignature' element value. Creation agent sine/queue category (eg: 1234AA)
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'agentSignature' element value. Creation agent sine/queue category (eg: 1234AA)
     * 
    ...
    /** 
     * Get the 'creationDate' element value. PNR creation date
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'creationDate' element value. PNR creation date
     * 
     * @param creationDate
     */
    ...
    /** 
     * Get the 'creationTime' element value. PNR creation time
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'creationTime' element value. PNR creation time
     * 
     * @param creationTime
     */
