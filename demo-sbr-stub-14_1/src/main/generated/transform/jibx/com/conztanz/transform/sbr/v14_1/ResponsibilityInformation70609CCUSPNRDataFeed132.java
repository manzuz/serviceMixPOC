 ...
 * <pre>
 * &lt;xs:complexType xmlns:xs="http://www.w3.org/2001/XMLSchema" name="ResponsibilityInformation_70609_C_CUS_PNRDataFeed_132">
 *   &lt;xs:sequence>
 ...
 * </pre>
 */
public class ResponsibilityInformation70609CCUSPNRDataFeed132
{
    ...
    /** 
     * Get the 'typeOfPnrElement' element value. To indicate the type of PNR element:  RR for Associated Cross Reference Record element  SP for Split Party element  RP for PNR Header RP line
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'typeOfPnrElement' element value. To indicate the type of PNR element:  RR for Associated Cross Reference Record element  SP for Split Party element  RP for PNR Header RP line
     * 
    ...
    /** 
     * Get the 'agentId' element value. 1. RR element: 2. SP element: 3. PNR Header:Agent initials and duty code as in ORG (eg: AASU)
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'agentId' element value. 1. RR element: 2. SP element: 3. PNR Header:Agent initials and duty code as in ORG (eg: AASU)
     * 
     * @param agentId
     */
